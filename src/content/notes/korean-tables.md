...
[데이터 피드](/services/data/)는 이 추출 체인을 고객이 지정한 출처에 붙여 매달 정제된 데이터를 납품하는 서비스입니다. 이미 가진 HWP 문서가 있다면 같은 추출기로 [한 번에 변환해 드립니다](/services/data/#price) — 10건 3만원부터, 표를 병합 셀까지 살린 Markdown·JSON.
