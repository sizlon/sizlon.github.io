  ...
  ko: {
    ...
    services: {
      ...
      rtm: {
        ...
        howH: '진행',
        how: [
          { name: '자료 접수 — 당일', text: 'RFP(제안요청서), 요구사항추적표, 설계 산출물(화면정의서·프로그램명세서처럼 ID 가 붙은 설계서), 있으면 검사기준서. NDA 뒤 파일로 받고, 하루 안에 범위와 고정가를 회신합니다.' },
        ...
        scopeDo: {
          ...
          groups: [
            { label: '규칙 — 같은 입력이면 매번 같은 결과', items: [
              ...
              '이전 회차 추적표에 있던 요구사항이 사유 없이 빠진 것(이전 표를 주실 때)',
