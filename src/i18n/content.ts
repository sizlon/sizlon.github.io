...
export const content = {
  ko: {
    ...
    home: {
      ...
      cards: [
        { key: 'rtm', situation: '감리 앞', name: '감리 대비표 사전 검토', terms: '설계단계 감리 1회 150~200만원', deliverable: '대비표 검토본(행마다 판정·근거) + 지적 예상 목록', relation: '공공 SI 수행사 PM. 설계 산출물이 나오고 감리 통보를 받은 시점에 맡깁니다. 대표가 직접 수행합니다.' },
    ...
    services: {
      ...
      rtm: {
        ...
        description: '공공 SI 감리 대비표 사전 검토 — RFP 요구사항을 설계 산출물과 대조해 감리 전에 빠진 것을 찾습니다. 감리원이 대비표로 보는 세 겹(형식 요건·추적성·설계 반영)을 문서만으로 먼저 보고, 대조 리포트·대비표 검토본·지적 예상 목록을 영업일 5일 안에 드립니다. 설계단계 감리 1회 150~200만원, 범위 확정 후 고정가.',
        eyebrow: '서비스 · 감리 앞',
        h1: '감리 대비표 사전 검토 — 요구사항추적표(RTM) 대조',
        sub: 'RFP 요구사항을 설계 산출물과 대조해, 감리 전에 빠진 것을 찾습니다.',
        price: '설계단계 감리 1회 150~200만원',
        offer: { minPrice: 1500000, maxPrice: 2000000, unitText: '설계단계 감리 1회' },
        priceNote: '범위 확정 후 고정가. 사업비 20억 미만이거나 기간 6개월 미만인 사업은 감리기준상 2단계 감리(설계·종료)라 대개 설계단계 1회에 해당합니다. 20억 이상 3단계 감리의 요구정의 단계(과업대비표·요구사항정의서)는 맡지 않습니다. 종료단계는 검사기준서와 시험결과서의 대응(빠진 시험·비어 있는 결과·조치 없는 실패)만 봅니다. 시험 수행 여부와 결과의 진위는 감리원이 확인합니다.',
