...
export const content = {
  ko: {
    ...
    engine: {
      title: '시즐론의 문서 검증 엔진',
      description: '요구 문서에서 요구조건을 원자 단위로 뽑아 응답 문서가 채웠는지 원문 인용으로 대조하는 엔진입니다. 미리보아 입찰 검증·감리 대비표 사전 검토·데이터 피드가 같은 코드 위에 있습니다. 잰 수치는 잣대와 함께, 잰 적 없는 도메인은 측정치 없음으로 적습니다.',
      eyebrow: '회사 · 엔진',
      h1: '시즐론의 문서 검증 엔진',
      lede: '요구 문서에서 요구조건을 원자 단위로 뽑고, 응답 문서가 그것을 채웠는지 원문 인용으로 대조합니다. 세 서비스가 이 한 엔진 위에 있고, 한 사람이 만들고 운영합니다. 수치는 잣대와 함께 공개하고, 잰 적 없는 도메인은 없다고 씁니다.',
      stepsH: '하는 일 — 네 단계',
      steps: [
      ...
      services: [
        ...
        { name: '데이터 피드', href: '/services/data/', what: '같은 파싱 층으로 공공 공고·HWP 첨부·PDF 표를 매달 정제해 납품합니다.', measured: '표 보존율 99.4% 가 이 층의 수치입니다.' },
      ],
    ...
    about: {
      ...
      sections: [
        { h: '무엇을 하는가 (시즐론, 2026.4~)', p: ['감리 대비표 사전 검토, 입찰 서류 검증(미리보아), 데이터 피드, 검색 품질 진단(Elasticsearch·OpenSearch)을 합니다. 앞의 셋은 같은 문서 검증 엔진 위에 있고, 검색 진단은 그 엔진을 만든 경력의 일입니다. 사이트가 바뀌면 스스로 복구하는 크롤러를 시즐론에서 만들었습니다.'] },
        { h: '작업 방식', p: [method] },
