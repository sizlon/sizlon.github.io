  ...
  ko: {
    ...
    engine: {
      ...
      steps: [
        ...
        { name: '대조', text: '원자마다 응답 문서에 반영됐는지 반영·부분·미반영으로 판정하고 근거 문장을 원문 그대로 붙입니다. 규칙으로 닫히는 것은 규칙으로 잽니다 — 서류 존재, 서류 간 식별 정보 일치, 금액 정합, 응찰 구조 선언. 날짜 순서와 발급 기한, 표 합계, 금액 상한·하한, 단위와 부가세 기준, 조건부 서류 검사는 2026년 9월에 넣어 그림자 실측 중입니다.', measure: '"확실" 판정 precision 96.5% — 같은 골든셋. 독립 3표가 일치하고 인용이 원문에 접지된 판정만 확실로 셉니다.' },
