  ...
  ko: {
    ...
    services: {
      ...
      rtm: {
        ...
        howH: '진행',
        how: [
          { name: '자료 접수 — 당일', text: '꼭 필요한 것은 셋입니다. ① RFP(제안요청서) — 요구사항 고유번호 표가 들어 있는 원본 파일. ② 요구사항추적표 — 요구사항 ID 가 RFP 고유번호이거나 그 번호로 시작해야 하고(SFR-001, SFR-001-01), 자체 번호를 쓰면 RFP 고유번호를 적은 출처 열이 있어야 합니다. ③ 추적표가 가리키는 ID(화면·프로그램 등)가 들어 있는 설계서 전부. 있으면 검사기준서도 함께 봅니다. NDA 뒤 파일로 받고, 접수 당일 파싱 가능 여부와 요구사항 수를, 다음 날 안에 범위와 고정가를 회신합니다.' },
