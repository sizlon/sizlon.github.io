...
export const content = {
  ko: {
      ...
      systems: [
        {
          ...
          uses: [
            { key: 'rtm', situation: '감리 앞', name: '요구사항 반영 사전 검토', terms: '설계단계 감리 1회 120~300만원(요구사항 수 구간별)', deliverable: '대비표 검토본(행마다 판정·근거) + 지적 예상 목록' },
    ...
    engine: {
      ...
      eyebrow: '회사 · 엔진',
      h1: '시즐론의 요구사항 대조 엔진',
      lede: '요구 문서에서 요구조건을 원자 단위로 뽑고, 응답 문서가 그것을 채웠는지 원문 인용으로 대조합니다. 미리보아와 요구사항 반영 사전 검토가 이 엔진 위에 있고, 데이터 피드는 HWP·PDF 표 추출 층만 같이 씁니다(수집은 자체 크롤러와 API 로 따로, 판정 층은 쓰지 않습니다). 한 사람이 만들고 운영합니다. 수치는 잣대와 함께 공개하고, 잰 적 없는 도메인은 없다고 씁니다.',
    ...
    about: {
      ...
      sections: [
        ...
        { h: '1인이라서 걱정되는 것', p: [
          ...
          '결과물 — 요구사항 반영 검토와 검색 진단의 산출물은 파일과 절차서라 고객 손에 남습니다. 미리보아는 사람 손 없이 돌고, 데이터 피드는 자동으로 수집·복구되고 갱신 로그가 남습니다.',
