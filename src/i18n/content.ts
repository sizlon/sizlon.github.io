...
export const content = {
  ko: {
    ...
    home: {
      ...
      cards: [
        { key: 'rtm', situation: '감리 앞', name: '감리 대비표 사전 검토', terms: '설계단계 감리 1회 150~200만원 · 3단계 감리 전체 400~500만원', deliverable: '대비표 검토본(행마다 판정·근거) + 지적 예상 목록', relation: '공공 SI 수행사 PM. 설계 산출물이 나오고 감리 통보를 받은 시점에 맡깁니다. 대표가 직접 수행합니다.' },
    ...
    services: {
      ...
      rtm: {
        ...
        deliverables: [
          ...
          '대비표 검토본 — 고객의 요구사항추적표 xlsx 에 판정·근거·비고 세 열을 붙인 파일. 행 순서와 서식은 그대로. 예: "SFR-020 | 화면 SCR-045 | 프로그램 PGM-118 → 부적합 예상 → 표가 가리킨 PGM-118 이 프로그램명세서에 없음"',
        ...
        faq: [
          ...
          { q: '자료는 어떻게 다루나요?', a: 'NDA 체결 뒤 파일로 받고, 납품 후 15일 안에 파기합니다. 외부 인력 없이 대표가 직접 수행합니다. 다른 고객의 문서는 어떤 결과물에도 쓰이지 않습니다.' },
        ],
        nextH,
        next: [
