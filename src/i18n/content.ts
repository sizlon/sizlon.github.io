  ...
  ko: {
    ...
    services: {
      ...
      rtm: {
        ...
        // 결과물 형식 견본(2026-09-11 오너 결정): 값은 전부 가상. 실제 RFP 로 만든 결과 샘플은 시스템 산출물이 나온 뒤 별도 페이지로.
        deliverLink: { href: '/samples/rtm-format-sample.xlsx', label: '결과물 형식 견본 xlsx 내려받기', line: '요약 · 추적표 검토본 · 표에 없는 요구사항 · 지적 예상 목록 · 과업대비표 · 검사기준서 대응, 여섯 시트. 사업명과 값은 전부 가상입니다.' },
        optionH: '추적표가 아직 없으면',
