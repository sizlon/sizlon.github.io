  ...
  ko: {
    ...
    bidcheck: {
      ...
      how: [
        ...
        { name: '판정 리포트', text: '요구조건마다 응답·부분·누락 판정과 원문 인용이 붙은 리포트를 받습니다. "확실"은 독립 3표 만장일치와 인용 접지를 다 통과한 항목만이고, 나머지는 "확인 필요"로 남깁니다.' },
      ],
      deliverH: '받는 것',
      deliverables: [
    ...
    engine: {
      ...
      layers: [
        ...
        '언어 모델 층 — 해석이 필요한 반영 여부. 독립 3표가 일치하고 인용이 원문에서 확인되어야 "확실"이고, 아니면 "확인 필요"입니다.',
      ],
      steps: [
      ...
      trustH: '판정을 어떻게 믿나',
      trust: [
        '해석이 필요한 판정은 독립 3표가 일치해야 "확실"이고, 아니면 "확인 필요"로 넘깁니다. 모르면 모른다고 씁니다.',
