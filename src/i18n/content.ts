    ...
    services: {
      ...
      rtm: {
        ...
        who: [
          ...
          '설계 산출물이 나왔고 설계단계 감리 통보를 받은 시점. 감리 실시 2주 전까지 맡기시면 됩니다.',
          '설계 열까지 채운 요구사항추적표가 있고, 감리 전에 그 표가 설계 산출물과 실제로 맞는지 확인하고 싶은 팀. 지난 감리에서 요구사항 반영 미흡이나 추적표 ID 불일치로 개선권고를 받은 적이 있는 팀.',
        ],
        howH: '진행',
        how: [
          { name: '자료 접수 — 당일', text: '꼭 필요한 것은 셋입니다. ① RFP(제안요청서) — 요구사항 고유번호 표가 들어 있는 원본 파일. ② 요구사항추적표 — 요구사항 ID 가 RFP 고유번호이거나 그 번호로 시작해야 하고(SFR-001, SFR-001-01), 자체 번호를 쓰면 RFP 고유번호를 적은 출처 열이 있어야 합니다. ③ 추적표가 가리키는 ID(화면·프로그램 등)가 들어 있는 설계서 전부. 있으면 검사기준서도 함께 봅니다. NDA 뒤 파일로 받고, 다음 날 안에 범위와 고정가를 회신합니다.' },
          { name: '대조·보고 — 영업일 5일 안', text: '아래 "하는 것"을 감리 전에 먼저 보고, 결과물 셋을 드립니다.' },
        ],
