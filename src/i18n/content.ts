...
export const content = {
  ko: {
    ...
    about: {
      ...
      lede: '시즐론은 서울 용산의 1인 소프트웨어 회사입니다. 검색 품질 진단, 공공 SI 감리 대응 문서, 월정액 데이터 피드를 대표가 직접 합니다.',
      sections: [
        { h: '무엇을 하는가 (시즐론, 2026.4~)', p: ['검색 품질 진단(Elasticsearch·OpenSearch), 공공 SI 감리 대응 문서, 월정액 데이터 피드를 합니다. 같은 엔진으로 미리보아를 운영합니다. 사이트가 바뀌면 스스로 복구하는 크롤러를 시즐론에서 만들었습니다.'] },
        { h: '작업 방식', p: [method] },
