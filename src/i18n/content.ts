  ...
  ko: {
    ...
    home: {
      ...
      cards: [
        ...
        { key: 'rtm', name: '감리 대응 RTM', terms: '설계단계 감리 1회 150~200만원 · 3단계 감리 전체 400~500만원', deliverable: '대비표 검토본(행마다 판정·근거) + 지적 예상 목록', relation: '공공 SI 납품 전. 지적된 검색 모듈은 검색 진단으로 이어집니다.' },
    ...
    services: {
      ...
      rtm: {
        ...
        description: '공공 SI 감리 대응 — RFP 요구사항 전부를 산출물과 대조해 감리 전에 빠진 것을 찾습니다. 고객의 요구사항추적표·과업대비표에 행마다 판정·근거를 붙인 검토본과 지적 예상 목록. 설계단계 감리 1회 150~200만원.',
        eyebrow: '서비스 · 감리 대응',
        ...
        priceNote: '범위 확정 후 고정가. 사업비 20억 미만·6개월 미만 사업은 감리기준상 2단계 감리(설계·종료)라 대개 설계단계 1회에 해당합니다.',
        whoH: 'PM 이 겪는 문제',
        who: [
        ...
        deliverH: '결과물',
        deliverables: [
          '대비표 검토본 — 고객의 요구사항추적표·과업대비표 원형에 행마다 판정과 원문 근거를 붙인 것 (표가 없으면 감리 수행 가이드 예시 컬럼으로 작성)',
