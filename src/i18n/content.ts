...
export const content = {
  ko: {
    ...
    home: {
      ...
      cards: [
        { key: 'rtm', situation: '감리 앞', name: '감리 대비표 사전 검토', terms: '설계단계 감리 1회 150~200만원 · 3단계 감리 전체 400~500만원', deliverable: '대비표 검토본(행마다 판정·근거) + 지적 예상 목록', relation: '공공 SI 수행사 PM. 설계 산출물이 나오고 감리 통보를 받은 시점에 맡깁니다. 대표가 직접 봅니다.' },
    ...
    bidcheck: {
      ...
      nextH,
      next: [
        { label: '낙찰 뒤 공공 SI 감리를 앞두면', line: '대비표를 감리 전에 대조합니다 — 행마다 판정과 원문 근거, 대표가 직접.', href: '/services/rtm/' },
        { label: '경쟁 입찰·낙찰 동향이 매달 필요하면', line: '나라장터 개찰 데이터를 정제해 CSV/JSON/API 로 납품합니다.', href: '/services/data/' },
      ],
