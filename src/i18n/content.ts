    ...
    services: {
      ...
      rtm: {
        ...
        who: [
          ...
          '설계 열까지 채운 요구사항추적표가 있고, 감리 전에 그 표가 설계 산출물과 실제로 맞는지 확인하고 싶은 팀. 지난 감리에서 요구사항 반영 미흡이나 추적표 ID 불일치로 개선권고를 받은 적이 있는 팀. 빠진 항목은 그대로 지적사항이 되고, 종료 감리를 못 넘기면 검수와 잔금이 밀립니다. 감리비는 발주기관이 내지만, 지적을 고치는 비용은 수행사 몫입니다.',
        ],
        howH: '진행',
        how: [
