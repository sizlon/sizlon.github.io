...
export const LASTMOD: Record<string, string> = {
  '/': '2026-09-14',   // 09-14 히어로 부제 크롤링 경력 삭제 · 감리 카드 가격 120~300 · 감리 카드 '대표가 직접 수행'(손작업 없음) · 09-11 v4 프레임: h1·카드 2단·태그라인
  ...
  '/services/miriboa/': '2026-09-14',   // 09-14 감리 링크 줄 '대표가 직접' 삭제 · 09-11 신설(입찰 서류 검증 관문)
