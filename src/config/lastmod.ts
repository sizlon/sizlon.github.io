...
export const LASTMOD: Record<string, string> = {
  ...
  '/services/miriboa/': '2026-09-14',   // 09-14 v5 위치 표시 · 09-14 감리 링크 줄 '대표가 직접' 삭제 · 09-11 신설(입찰 서류 검증 관문)
  ...
  '/engine/': '2026-09-14',   // 09-14 v5 허브 순서·규칙/언어 모델 층·검증 단계 사람 검수 문구 · 09-14 감리 측정 문구(실제 감리 지적 대조) · 09-11 게재 + lede 잣대 문장
