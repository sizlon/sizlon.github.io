...
export const LASTMOD: Record<string, string> = {
  '/': '2026-09-14',   // 09-14 감리 카드 '대표가 직접 수행'(손작업 없음) · 09-11 v4 프레임: h1·카드 2단·태그라인
  ...
  '/services/rtm/': '2026-09-14',   // 09-14 종료단계 문장 삭제 · 3단계 상품 내림·지적 목록 최대 6건·접수 목록·LLM 전송 고지·h1 과업대비표 삭제 · 손작업 제거·넘치는 문구 수선(그대로·실제로·병합·새 표·통화) · 09-12 FAQ 감리법인 반론·누구 항목 한 문장·형식 견본 일곱 시트(출력기 산출)
