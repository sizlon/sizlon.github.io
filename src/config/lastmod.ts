...
export const LASTMOD: Record<string, string> = {
  '/': '2026-09-14',   // 09-14 h1 세 줄(대조하는 엔진·수집·정제·한국어 검색 시스템) · v5 소프트웨어 회사·시스템 셋 · 09-14 히어로 부제 크롤링 경력 삭제 · 감리 카드 가격 120~300 · 감리 카드 '대표가 직접 수행'(손작업 없음) · 09-11 v4 프레임: h1·카드 2단·태그라인
  ...
  '/services/miriboa/': '2026-09-14',   // 09-14 3표 설명 · 09-14 v5 위치 표시 · 09-14 감리 링크 줄 '대표가 직접' 삭제 · 09-11 신설(입찰 서류 검증 관문)
  '/services/data/': '2026-09-11',   // 09-11 sub·개찰 매일 수집
  '/work/': '2026-09-14',   // 09-14 3표 설명 · 09-11 기술 문단·미리보아 tag
  '/about/': '2026-09-14',   // 09-14 작업 방식 문구(사람 승인 삭제) · 09-11 v4 서비스 넷
  '/engine/': '2026-09-14',   // 09-14 단계 절 제목 '작동 방식' · 3표 설명(같은 모델·세 번·한계·감리 5중 4) · 09-14 v5 허브 순서·규칙/언어 모델 층·검증 단계 사람 검수 문구 · 09-14 감리 측정 문구(실제 감리 지적 대조) · 09-11 게재 + lede 잣대 문장
